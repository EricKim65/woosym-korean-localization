...
if ( ! class_exists( 'WSKL_Sym_Mvc_Admin_API' ) ) :

	class WSKL_Sym_Mvc_Admin_API {
		...
		public function display_field( $data = array(), $post = FALSE, $echo = TRUE ) {
			...
			switch ( $field['type'] ) {
				...
				case 'email':
					...
					break;
				case 'longtext':
					$html .= '<input id="' . esc_attr( $field['id'] ) . '" type="text" name="' . esc_attr( $option_name ) . '" style="width:400px;" placeholder="' . esc_attr( $field['placeholder'] ) . '" value="' . esc_attr( $data ) . '" />' . "\n";
					break;
				case 'shorttext':
					$html .= '<input id="' . esc_attr( $field['id'] ) . '" type="text" name="' . esc_attr( $option_name ) . '" style="width:50px;" placeholder="' . esc_attr( $field['placeholder'] ) . '" value="' . esc_attr( $data ) . '" />' . "\n";
					break;
				...
				case 'textarea':
					$html .= '<textarea id="' . esc_attr( $field['id'] ) . '" rows="5" cols="57" name="' . esc_attr( $option_name ) . '" placeholder="' . esc_attr( $field['placeholder'] ) . '">' . $data . '</textarea><br/>' . "\n";
					break;
		...
		public function meta_box_content( $post, $args ) {
			...
			$fields = apply_filters( $post->post_type . '_custom_fields',
