...
class WSKL_Social_Login {
  ...
  public static function init() {
    ...
    add_action( 'wp_enqueue_scripts', function() {
      wp_enqueue_style( 'wskl-login-css', plugin_dir_url( WSKL_MAIN_FILE ) . 'assets/css/login.css', NULL, WSKL_VERSION );
    } );
  ...
  public static function service_social_login_fb() {
    ...
    if ( ( isset( $_GET['sym-api'] ) && $_GET['sym-api'] == 'service-social-login-fb' ) || ( isset( $_GET['code'] ) && get_option( WSKL_PREFIX . 'sym-api-' . $_SERVER['HTTP_CLIENT_IP'] ) == 'service-social-login-fb' ) ) {
  ...
  public static function process_social_login() {
    ...
    if ( isset( $_GET['sym-api'] ) AND $_GET['sym-api'] == 'process-social-login' ) {
      list( $social_code, $social_id, $user_name, $user_nick, $user_email ) = explode( "|", static::decryptIt( $_GET['token'] ) );
