...
final class Woosym_Korean_Localization_Settings extends WSKL_Sym_Mvc_Settings {
	...
	private function settings_fields() {  // specify settings fields
		...
		$debug_link = 'http://' . $_SERVER['HTTP_HOST'] . str_replace( 'wp-admin',
		                                                               'wp-content',
		                                                               $prefix ) . '/plugins/sym-mvc-framework/includes/debug.php';
			...
			case 'iamport':
				array_push( $settings['checkout-payment-gate']['fields'],
				            ...
				            array(
					            ...
					            'description' => __( '<span class="wskl-notice">아임포트 결제와 관련된 내용은 아임포트 서버에서 실행되는 내용이므로 다보리에서 책임지지 않습니다. </span><br><a href="https://admin.iamport.kr/settings" target="_blank">아임포트 PG 설정 바로가기</a><br/>
			...
			case 'kcp':
				array_push( $settings['checkout-payment-gate']['fields'],
				            array(
					            ...
					            'label'       => __( '사이트이름',
					                                 'wskl' ),
					            'description' => __( '자체적으로 정한 사이트 이름을 입력해주십시오. (반드시 영문자로 설정하여 주시기 바랍니다.)',
					                                 'wskl' ),
					            'type'        => 'longtext',
					            'default'     => '',
					            'placeholder' => __( '예) 다보리 쇼핑몰',
					                                 'wskl' ),
				            ),
				            array(
					            'id'          => 'kcp_sitecd',
					            'label'       => __( 'Site Code', 'wskl' ),
					            'description' => __( 'KCP 에서 발급된 Site Code 를 정확히 입력해주십시오.(중요)',
					                                 'wskl' ),
					            'type'        => 'longtext',
					            'default'     => '',
				            ...
				            array(
					            ...
					            'description' => __( 'KCP 에서 발급된 Site Key를 정확히 입력해주십시오.(중요)',
					                                 'wskl' ),
					            'type'        => 'longtext',
					            'default'     => '',
					            'placeholder' => __( '예) 3grptw1.zW0GSo4PQdaGvsF__',
					                                 'wskl' ),
				            ),
				            array(
					            'id'          => 'dummy_11',
					            'label'       => __( '상점등록', 'wskl' ),
					            'description' => __( '<span class="wskl-notice">상점등록 과정은 매우 중요한 사항이므로  정확히 숙지하고 실행해주셔야 합니다. </span></br>
			...
			case 'inicis':
				array_push( $settings['checkout-payment-gate']['fields'],
				            array(
					            ...
					            'label'       => __( '키패스워드',
					                                 'wskl' ),
					            'description' => __( '키패스워드입력 - 상점관리자 패스워드와 무관합니다.(중요)',
					                                 'wskl' ),
					            'type'        => 'text',
					            'default'     => '',
					            'placeholder' => __( '예) 1111',
					                                 'wskl' ),
				            ),
				            array(
					            'id'          => 'inicis_mid',
					            'label'       => __( '상점 아이디', 'wskl' ),
					            'description' => __( '이니시스에서 발급된 상점아이디를 대소문자 구분하여 입력해주십시오.(중요)',
					                                 'wskl' ),
					            'type'        => 'text',
					            'default'     => '',
				            ...
				            array(
					            ...
					            'description' => __( '상점의 홈페이지 주소를 입력해주십시오.( http://포함 )',
					                                 'wskl' ),
					            'type'        => 'longtext',
					            'default'     => '',
					            'placeholder' => __( '예) http://www.your_domain.co.kr',
					                                 'wskl' ),
				            ),
				            array(
					            'id'          => 'dummy_11',
			...
			case 'ags':
				array_push( $settings['checkout-payment-gate']['fields'],
				            array(
					            ...
					            'label'       => __( '상점명',
					                                 'wskl' ),
					            'description' => __( '올더게이트 상점명을 입력해주십시오',
					                                 'wskl' ),
					            'type'        => 'text',
					            'default'     => '',
					            'placeholder' => __( '예) 올더게이트',
					                                 'wskl' ),
				            ),
				            array(
					            'id'          => 'ags_storeid',
					            'label'       => __( '상점 ID', 'wskl' ),
					            'description' => __( '올더게이트에서 발급된 상점ID를 정확히 입력해주십시오.(중요)',
					                                 'wskl' ),
					            'type'        => 'text',
					            'default'     => '',
				            ...
				            array(
					            ...
					            'type'        => 'longtext',
					            'default'     => '',
					            'placeholder' => __( '예) http://www.allthegate.com',
					                                 'wskl' ),
				            ),
				            array(
					            'id'          => 'ags_hp_id',
					            'label'       => __( 'CPID(모바일결제)', 'wskl' ),
					            'description' => __( '올더게이트에서 발급받으신 CPID로 변경',
					                                 'wskl' ),
					            'type'        => 'text',
					            'default'     => '',
					            'placeholder' => '',
				            ...
				            array(
					            ...
					            'description' => __( '올더게이트에서 발급받으신 비밀번호로 변경',
					                                 'wskl' ),
					            'type'        => 'text',
					            'default'     => '',
					            'placeholder' => '',
				            ...
				            array(
					            ...
					            'description' => __( '올더게이트에서 발급받으신 상점만 입력',
					                                 'wskl' ),
					            'type'        => 'text',
					            'default'     => '',
					            'placeholder' => '',
				            ...
				            array(
					            ...
					            'description' => __( '올더게이트에서 발급받으신 상품코드로 변경',
					                                 'wskl' ),
					            'type'        => 'text',
					            'default'     => '',
					            'placeholder' => '',
				            ...
				            array(
					            ...
					            'description' => __( '올더게이트에서 발급받으신 상품종류로 변경: 디지털컨텐츠=1, 실물(상품)=2',
					                                 'wskl' ),
					            'type'        => 'text',
					            'default'     => '',
					            'placeholder' => '',
			...
			case 'iamport':
				array_push( $settings['checkout-payment-gate']['fields'],
				            array(
					            ...
					            'label'       => __( '가맹점 식별코드',
					                                 'wskl' ),
					            'description' => __( '아임포트의 가맹점 식별코드를 입력하여 주십시오.',
					                                 'wskl' ),
					            'type'        => 'text',
					            'default'     => '',
					            'placeholder' => '',
				            ...
				            array(
					            ...
					            'description' => __( '아임포트의 REST API 키를 입력하여 주십시오.',
					                                 'wskl' ),
					            'type'        => 'text',
					            'default'     => '',
					            'placeholder' => '',
				            ...
				            array(
					            ...
					            'label'       => __( 'REST API secret',
					                                 'wskl' ),
					            'description' => __( '아임포트의 REST API secret 입력하여 주십시오.',
					                                 'wskl' ),
					            'type'        => 'longtext',
					            'default'     => '',
					            'placeholder' => '',
		...
		if ( ! in_array( $pg_agency, array( 'payapp', 'iamport' ) ) ) {
			array_push( $settings['checkout-payment-gate']['fields'],
			            array(
				            ...
				            'label'       => __( '추가설정내용',
				                                 'wskl' ),
				            'description' => __( '<span class="wskl-notice">해당페이지 설정후 반드시 추가해야할 "우커머스 결제설정" 내용입니다.</span><a href="' . esc_url( add_query_arg( array(
					                                                                                                                                              'page' => 'wc-settings',
					                                                                                                                                              'tab'  => 'checkout',
				                                                                                                                                              ),
				                                                                                                                                              admin_url( 'admin.php' ) ) ) . '" target="_blank">결제설정 바로가기</a><br/>
		...
		$settings['ship_tracking'] = array(
			...
			'fields'      => array(
				...
				array(
					...
					// array( $agent_default, $agents[ $agent_default ] ),
				),
				array(
				...
				array(
					...
					'description' => __( '회원 가입 기능을 제공합니다.', 'wskl' ),
					'type'        => 'checkbox',
					'default'     => '',
				),
			),
		...
		if ( get_option( WSKL_PREFIX . 'fb_login' ) == 'on' ) {
			array_push( $settings['social-login']['fields'],
			            array(
				            'id'          => 'fb_app_id',
				            'label'       => __( '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[페이스북] App ID',
				                                 'wskl' ),
				            'description' => __( '페이스북의 App ID 를 입력하십시오',
				                                 'wskl' ),
				            'type'        => 'longtext',
				            'default'     => '',
				            'placeholder' => '',
			            ...
			            array(
				            'id'          => 'fb_app_secret',
				            'label'       => __( '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[페이스북] App Secret',
				                                 'wskl' ),
				            'description' => __( '페이스북의 App Secret을 입력하십시오',
				                                 'wskl' ),
				            'type'        => 'longtext',
				            'default'     => '',
				            'placeholder' => '',
			            ...
			            array(
				            ...
				            'label'       => __( '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[페이스북]링크 텍스트',
				                                 'wskl' ),
				            'description' => __( '로그인 링크에 보여질 텍스트 또는 이미지 태그를 입력하십시오. 기본 아이콘을 사용하려면 \'[icon]\'으로 입력하세요.',
				                                 'wskl' ),
				            'type'        => 'textarea',
				            'default'     => '[icon]',
				            'placeholder' => '',
		...
		array_push( $settings['social-login']['fields'],
		            array(
			            'id'          => 'naver_login',
			            'label'       => __( '네이버 계정으로 로그인 활성화 ',
			                                 'wskl' ),
			            'description' => __( '활성화이후  발급키 입력창이 나타납니다. ',
			                                 'wskl' ),
			            'type'        => 'checkbox',
			            'default'     => '',
		            ) );
		...
		if ( get_option( $this->_prefix . 'naver_login' ) == 'on' ) {
			array_push( $settings['social-login']['fields'],
			            array(
				            'id'          => 'naver_client_id',
				            'label'       => __( '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[네이버] Client ID',
				                                 'wskl' ),
				            'description' => __( '네이버의 Client ID를 입력하십시오',
				                                 'wskl' ),
				            'type'        => 'longtext',
				            'default'     => '',
				            'placeholder' => '',
			            ...
			            array(
				            ...
				            'label'       => __( '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[네이버] Client Secret',
				                                 'wskl' ),
				            'description' => __( '네이버의 Client Secret 을 입력하십시오',
				                                 'wskl' ),
				            'type'        => 'longtext',
				            'default'     => '',
				            'placeholder' => '',
			...
			'fields'      => array(
				...
				array(
					...
					'description' => ( site_url() == wskl_get_option( 'ip_block_target' ) ) ? '<span class="wskl-info">' . __( '차단 기능이 동작합니다.',
					                                                                                                           'wskl' ) . '</span>' : '<span class="wskl-notice">' . __( '도메인이 변경되어 기능이 중지되었습니다. 설정 저장 버튼을 눌러 다시 활성화시켜 주세요',
					                                                                                                                                                                     'wskl' ) . '</span>',
				),
			),
		);
	...
	public function callback_admin_enqueue_scripts() {
		...
		wskl_enqueue_script( 'dabory-admin-js',
