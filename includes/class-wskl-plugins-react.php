	...
	class WSKL_Plugins_React {
		...
		public static function output_woocommerce_warning() {
			...
			printf( '<div class="notice error"><p>%s</p></div>',
			        __( '다보리 알림: 우커머스 플러그인이 비활성화되어 있습니다. 우커머스-심포니 통합 플러그인의 기능을 정지합니다.',
			            'wskl' ) );
		}
		...
		public static function output_sym_mvc_deactivation() {
			...
			printf( '<div class="notice notice-warning"><p>%s<br/>%s</p></div>',
			        __( '다보리 알림: SYM MVC FRAMEWORK 플러그인은 더이상 사용되지 않습니다. 플러그인을 비활성화시킵니다.',
			            'wskl' ),
		...
		public static function output_iamport_is_active() {
			...
			printf( '<div class="error notice"><p>%s</p></div>',
			        __( '다보리 알림: "우커머스용 아임포트 플러그인"이 활성화되어 있습니다! 다보리의 아임포트 지불 기능과 겹칩니다. "우커머스용 아임포트 플러그인"을 비활성화시켜 주세요.',
			            'wskl' ) );
		}
		...
		public static function wp_members() {
			...
			add_action( 'admin_notices',
			            array( __CLASS__, 'output_wp_member_is_inactive' ) );
		}

		public static function output_wp_member_is_inactive() {

			printf( '<div class="error notice"><p>%s</p></div>',
			        __( '다보리 알림: WP Members 플러그인이 비활성화되어 있습니다. 다보리 멤버스의 기능을 사용하려면 이 플러그인을 활성화시켜 주세요.',
			            'wskl' ) );
		}
	}
